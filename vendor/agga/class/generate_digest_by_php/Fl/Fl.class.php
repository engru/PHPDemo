 ...
 * 2010-11-20
 * 
 * @author lichengyin (http://www.welefen.com),zhaoxianlie (http://www.alienfe.com)
 *
 */
class Fl {
	const FL_EOF 						= 1;   //结束
	...
	public static function getInstance(){
		if(self::$_instance === null){
			...
			//读取并赋值Smarty的左右定界符
			if(defined("SMARTY_LEFT_DELIMITER") && defined("SMARTY_RIGHT_DELIMITER")){
         		self::$_instance->left_delimiter = SMARTY_LEFT_DELIMITER;
         		self::$_instance->right_delimiter = SMARTY_RIGHT_DELIMITER;
			}
		}
