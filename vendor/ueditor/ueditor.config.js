...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["link","gmap","pagebreak","insertimage","emotion","insertvideo","attachment","date","time","map","horizontal","anchor","insertcode","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","removeformat","formatmatch","fontfamily","fontsize","inserttable"]]
